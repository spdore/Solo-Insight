...
import { AiAccessState } from '../types';
...
export const AiLockModal: React.FC<AiLockModalProps> = ({ isOpen, onClose, onSuccess, accessState, onUpdateState }) => {
        ...
        <div className="flex flex-col items-center mb-6">
            ...
            <p className="text-sm text-slate-400 mt-1 text-center">
                {isLocked 
                    ...
                    : "Enter the access code to unlock AI Insights."}
            </p>
        </div>
